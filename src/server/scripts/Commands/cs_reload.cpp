...
public:
    ...
    ChatCommand* GetCommands() const
    {
        ...
        static ChatCommand reloadCommandTable[] =
        {
            ...
            { "stargate_string",               SEC_ADMINISTRATOR, true,  &HandleReloadStarGateStringCommand,              "", NULL },
    ...
    static bool HandleReloadAllCommand(ChatHandler* handler, const char* /*args*/)
    {
        ...
        HandleReloadStarGateStringCommand(handler,"");
    ...
    static bool HandleReloadStarGateStringCommand(ChatHandler* handler, const char* /*args*/)
    {
        sLog->outString("Re-Loading StarGate_string Table!");
        sObjectMgr->LoadStarGateStrings();
        handler->SendGlobalGMSysMessage("DB table `StarGate_string` reloaded.");
        return true;
    }
