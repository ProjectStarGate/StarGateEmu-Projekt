...
char serviceLongName[] = "StarGateEMU world service";
char serviceDescription[] = "StarGateEMU World of Warcraft emulator world service";
/*
...
extern int main(int argc, char **argv)
{
    ...
    sLog->outString("Konfigurationsdatei %s.", cfg_file);
