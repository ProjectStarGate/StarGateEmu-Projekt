...
#define OUT_LOAD_INST_DATA_FAIL        sLog->outDebug(LOG_FILTER_TSCR, "TSCR: Unable to load Instance Data for Instance %s (Map %d, Instance Id: %d).", instance->GetMapName(), instance->GetId(), instance->GetInstanceId())
