...
void WorldSession::HandleAddFriendOpcode(WorldPacket & recv_data)
{
    ...
    std::string friendName = GetStarGateString(LANG_FRIEND_IGNORE_UNKNOWN);
...
void WorldSession::HandleAddIgnoreOpcode(WorldPacket & recv_data)
{
    ...
    std::string IgnoreName = GetStarGateString(LANG_FRIEND_IGNORE_UNKNOWN);
...
void WorldSession::HandleMoveTimeSkippedOpcode(WorldPacket & recv_data)
{
    ...
    /*
        ...
        sLog->outDebug(LOG_FILTER_NETWORKIO, "WORLD: CMSG_MOVE_TIME_SKIPPED");
...
/*
    ...
    sLog->outDebug(LOG_FILTER_NETWORKIO, "WORLD: CMSG_FORCE_MOVE_UNROOT_ACK");
...
/*
    ...
    sLog->outDebug(LOG_FILTER_NETWORKIO, "WORLD: CMSG_FORCE_MOVE_ROOT_ACK");
...
void WorldSession::HandleWardenDataOpcode(WorldPacket& recv_data)
{
    ...
    /*
        uint8 tmp;
        recv_data >> tmp;
        sLog->outDebug(LOG_FILTER_NETWORKIO, "Received opcode CMSG_WARDEN_DATA, not resolve.uint8 = %u", tmp);
    */
}
...
void WorldSession::HandleRealmSplitOpcode(WorldPacket & recv_data)
{
    ...
    data << split_date;
    SendPacket(&data);
    //sLog->outDebug(LOG_FILTER_NETWORKIO, "response sent %u", unk);
}
...
{
    /*
        sLog->outDebug(LOG_FILTER_NETWORKIO, "WORLD: CMSG_REQUEST_PET_INFO");
        recv_data.hexlike();
    */
}
