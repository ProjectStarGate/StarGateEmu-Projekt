...
#define MIN_StarGate_STRING_ID           1                    // 'StarGate_string'
#define MAX_StarGate_STRING_ID           2000000000
#define MIN_DB_SCRIPT_STRING_ID        MAX_StarGate_STRING_ID // 'db_script_string'
...
typedef UNORDERED_MAP<int32, StarGateStringLocale> StarGateStringLocaleMap;
...
class ObjectMgr
{
    ...
    public:
        ...
        */
        ...
        bool LoadStarGateStrings(char const* table, int32 min_value, int32 max_value);
        bool LoadStarGateStrings() { return LoadStarGateStrings("StarGate_string", MIN_StarGate_STRING_ID, MAX_StarGate_STRING_ID); }
        ...
        StarGateStringLocale const* GetStarGateStringLocale(int32 entry) const
        {
            StarGateStringLocaleMap::const_iterator itr = mStarGateStringLocaleMap.find(entry);
            if (itr == mStarGateStringLocaleMap.end()) return NULL;
            return &itr->second;
        }
        const char *GetStarGateString(int32 entry, LocaleConstant locale_idx) const;
        const char *GetStarGateStringForDBCLocale(int32 entry) const { return GetStarGateString(entry, DBCLocaleIndex); }
...
//        GraveYardMap        mGraveYardMap;
    ...
    private:
        ...
        StarGateStringLocaleMap mStarGateStringLocaleMap;
...
// scripting access functions
 bool LoadStarGateStrings(char const* table, int32 start_value = MAX_CREATURE_AI_TEXT_STRING_ID, int32 end_value = std::numeric_limits<int32>::min());
 uint32 GetAreaTriggerScriptId(uint32 trigger_id);
 uint32 GetScriptId(const char *name);
