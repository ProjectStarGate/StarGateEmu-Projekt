            ...
            case SPELLFAMILY_DRUID:
            {
                switch (auraSpellInfo->Id)
                {
                    ...
                    case 67353:
                    {
                        switch (GetShapeshiftForm())
                        {
                            case FORM_CAT:      trigger_spell_id = 67355; break;                            case FORM_BEAR:
        ...
        case 89490:
            if (procSpell->Id == 2050 || procSpell->Id == 2060 || procSpell->Id == 2061)
            {
                if (pVictim->HasAura(6788))
                {
                    ...
                    if (newCooldownDelay <= uint32((triggeredByAura->GetSpellProto()->GetSpellEffect(0)->EffectBasePoints)*1000))
            newCooldownDelay = 0;
          else
